...
Voice mode ưu tiên màn hình tập trung, có nút đóng rõ ràng, chỉ báo đang nghe/đang xử lý/không nghe được và waveform theo input thực. Nhánh Voice hiện đo âm lượng micro để điều khiển waveform khi được cấp quyền; dữ liệu PCM chỉ dùng tại chỗ cho hiệu ứng, không lưu hoặc gửi lên dịch vụ. Chuyển giọng nói thành text, lập đơn/ghi chi hoặc hỏi đáp bằng audio vẫn là đích tích hợp sau. Output khi tích hợp phải lên **bản nháp để sửa/xác nhận**, không tự ghi sổ; nếu AI lỗi hoặc timeout, giữ input và cho chuyển sang text/POS. Đây là hướng tương tác dựa trên [`FR-008`, `FR-020`, `FR-021`, `NFR-006`, `AC-008`, `AC-010`, `AC-011`](../product/product-requirements.md), chưa phải toàn bộ hành vi đã chạy trong app.
